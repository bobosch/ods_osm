...
INSERT INTO tx_odsosm_layer VALUES ('6', '0', '0', '0', '0', '2048', '0', '1', 'Google Streets', '0', 'new OpenLayers.Layer.Google(\'###TITLE###\',{\'sphericalMercator\':true,numZoomLevels:20})', 'http://maps.google.com/maps/api/js?v=3&amp;sensor=false', '', '', '0', '', '', 'http://maps.google.com/');
INSERT INTO tx_odsosm_layer VALUES ('7', '0', '0', '0', '0', '2304', '0', '1', 'Google Physical', '0', 'new OpenLayers.Layer.Google(\'###TITLE###\',{type:google.maps.MapTypeId.TERRAIN,\'sphericalMercator\':true,numZoomLevels:16})', 'http://maps.google.com/maps/api/js?v=3&amp;sensor=false', '', '', '0', '', '', 'http://maps.google.com/');
INSERT INTO tx_odsosm_layer VALUES ('8', '0', '0', '0', '0', '2560', '0', '1', 'Google Satellite', '0', 'new OpenLayers.Layer.Google(\'###TITLE###\',{type:google.maps.MapTypeId.SATELLITE,\'sphericalMercator\':true,numZoomLevels:22})', 'http://maps.google.com/maps/api/js?v=3&amp;sensor=false', '', '', '0', '', '', 'http://maps.google.com/');
INSERT INTO tx_odsosm_layer VALUES ('9', '0', '0', '0', '0', '2816', '0', '1', 'Google Hybrid', '0', 'new OpenLayers.Layer.Google(\'###TITLE###\',{type:google.maps.MapTypeId.HYBRID,\'sphericalMercator\':true,numZoomLevels:20})', 'http://maps.google.com/maps/api/js?v=3&amp;sensor=false', '', '', '0', '', '', 'http://maps.google.com/');
...
INSERT INTO tx_odsosm_layer VALUES ('14', '0', '0', '0', '0', '1152', '0', '0', 'Hike & Bike Map', '0', '', '', '', 'http://toolserver.org/tiles/hikebike/{z}/{x}/{y}.png', '0', '', '', 'http://www.hikebikemap.de/');
INSERT INTO tx_odsosm_layer VALUES ('15', '0', '0', '0', '0', '1592', '0', '0', 'Hillshading (NASA SRTM3 v2)', '1', '', '', '', 'http://toolserver.org/~cmarqu/hill/{z}/{x}/{y}.png', '0', '', '', '');
INSERT INTO tx_odsosm_layer VALUES ('16', '0', '0', '0', '0', '1600', '0', '0', 'By Night', '1', 'new OpenLayers.Layer.TMS(\'###TITLE###\',\'http://toolserver.org/tiles/lighting/\',{type:\'png\',getURL:getTileURL,displayOutsideMaxExtent:true,isBaseLayer:false,transparent:true,opacity:0.72,###VISIBLE###})', '', '', 'http://toolserver.org/tiles/lighting/{z}/{x}/{y}.png', '0', '', '', '');
...
INSERT INTO tx_odsosm_layer VALUES ('18', '0', '0', '0', '0', '640', '0', '0', 'Mapnik BW', '0', '', '', '', 'http://{s}.www.toolserver.org/tiles/bw-mapnik/{z}/{x}/{y}.png', '19', '', '© <a href="http://www.openstreetmap.org/copyright">OpenStreetMap contributors</a>', 'http://toolserver.org/~osm/styles/');
