...
INSERT INTO tx_odsosm_layer VALUES ('18', '0', '0', '0', '0', '640', '0', '0', 'Mapnik BW', '0', 'new OpenLayers.Layer.OSM.Toolserver(\'###TITLE###\',\'bw-mapnik\')', 'typo3conf/ext/ods_osm/res/layers/toolserver.js', '', 'http://{s}.www.toolserver.org/tiles/bw-mapnik/{z}/{x}/{y}.png', '19', '', 'http://toolserver.org/~osm/styles/');
...
INSERT INTO tx_odsosm_layer VALUES ('26', '0', '0', '0', '0', '1056', '0', '0', 'MapQuest', '0', 'new OpenLayers.Layer.OSM("###TITLE###",["http://otile1.mqcdn.com/tiles/1.0.0/osm/${z}/${x}/${y}.png","http://otile2.mqcdn.com/tiles/1.0.0/osm/${z}/${x}/${y}.png","http://otile3.mqcdn.com/tiles/1.0.0/osm/${z}/${x}/${y}.png","http://otile4.mqcdn.com/tiles/1.0.0/osm/${z}/${x}/${y}.png"],{attribution:"Tiles courtesy of <a href=\\\'http://www.mapquest.com/\\\' target=\\\'_blank\\\'>MapQuest</a> <img src=\\\'http://developer.mapquest.com/content/osm/mq_logo.png\\\'>",keyid:"mapquest",displayOutsideMaxExtent:!0,wrapDateLine:!0,numZoomLevels:19,layerCode:"Q"})', '', '', 'http://otile{s}.mqcdn.com/tiles/1.0.0/osm/{z}/{x}/{y}.png', '0', '1234', 'http://www.mapquest.com/');
