...
import * as L from "@bobosch/ods-osm/esm/leaflet-src.esm.js";
...
class LeafletBackendModule {
    constructor() {
      ...
      DocumentService.ready().then(() => {
        const locationMapWizard = document.querySelector(".coordinatepickerWizard");
        console.log(locationMapWizard);
    ...
    initialize(element) {
      element.addEventListener("click", () => {
        ...
        this.zoomLevel = element.dataset.zoom;
